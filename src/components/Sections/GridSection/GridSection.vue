...
let imagesElements = [
  {
    ...
    text: "(Ovens)",
    src: "/images/3.webp",
    texture: new THREE.TextureLoader().load("/images/3.webp"),
  },
  {
    id: 1,
    ref: "img2",
    ...
    text: "(Warming drawer)",
    src: "/images/4.webp",
    texture: new THREE.TextureLoader().load("/images/4.webp"),
  },
  {
    id: 2,
    ref: "img3",
    ...
    text: "(Extractors)",
    src: "/images/6.webp",
    texture: new THREE.TextureLoader().load("/images/6.webp"),
  },
  {
    id: 3,
    ref: "img4",
    ...
    src: "/images/9.webp",
    texture: new THREE.TextureLoader().load("/images/9.webp"),
  },
  {
    id: 4,
    ref: "img5",
    ...
    text: "(Cooktop)",
    src: "/images/8.webp",
    texture: new THREE.TextureLoader().load("/images/8.webp"),
  },
  {
    id: 5,
    ref: "img6",
    ...
    text: "(Refrigerators)",
    src: "/images/11.webp",
    texture: new THREE.TextureLoader().load("/images/11.webp"),
  },
  {
    id: 6,
    ref: "img7",
    ...
    text: "(Dishwasher)",
    src: "/images/5.webp",
    texture: new THREE.TextureLoader().load("/images/5.webp"),
  },
];
